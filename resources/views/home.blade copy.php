                    ...
                    <div class="container" style="padding: 1rem;">
                      ...
                      <table class="table table-dark" >
                        <h3 style="color:rgb(24, 22, 22)"><b>Tenants List</b></h3>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>{{$post->email}}</td>
                              <td>0{{$post->phone}}</td>
                              <td style="text-align:center;">{{$post->property['propertyname']}}</td>
                       ...
                       <!--- <a href="/tenants/{{$post->id}}/edit" id="edit" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit </a> -->
                        ...
                        <a href="/tenants/{{$post->id}}" class="btn btn-xs btn-primary"  id="show-customer" data-toggle="modal" data-target="#crud-modal-show-{{$post->id}}" ><i class="fa fa-eye"></i> View </a>
                        <a href="{{ route('tenant.edit',$post->id) }}" data-toggle="modal" data-target="#theModal{{ $post->id }}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit </a>
